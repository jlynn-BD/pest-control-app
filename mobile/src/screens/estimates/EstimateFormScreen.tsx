...
const styles = StyleSheet.create({
  ...
  rowHalf: { flex: 1 },
  removeLink: { color: colors.danger, fontSize: 13, fontWeight: "600", paddingVertical: 12 },
  addLink: { color: colors.primary, fontWeight: "600", fontSize: 14, marginBottom: 16, paddingVertical: 12 },
