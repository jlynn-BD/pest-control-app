...
const styles = StyleSheet.create({
  ...
  todayLink: { marginLeft: "auto", color: colors.primary, fontWeight: "700", fontSize: 13 },
  dot: { width: 9, height: 9, borderRadius: 5 },
  grid: { flexDirection: "row", flexWrap: "wrap" },
  cell: { width: `${100 / 7}%`, alignItems: "center", paddingVertical: 2 },
  weekday: { fontSize: 11, fontWeight: "700", color: colors.textMuted, textTransform: "uppercase", paddingVertical: 4 },
  dayBox: {
    width: "88%",
    minHeight: 46,
    borderRadius: 10,
